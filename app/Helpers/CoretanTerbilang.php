...
class CoretanTerbilang
{
    public static function convert($number)
    {
        ...
        if ($number < 12) {
            ...
            $temp = self::convert((int)($number / 1000000000)) . " milyar" . self::convert(fmod($number, 1000000000));
        } else if ($number < 1000000000000000) {
            $temp = self::convert((int)($number / 1000000000000)) . " trilyun" . self::convert(fmod($number, 1000000000000));
        }

        return trim(ucwords($temp));
    }
}
